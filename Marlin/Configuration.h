...
#define TEMP_BED_WINDOW     	3///1       // (degC) Window around target to start the residency timer x degC early.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  #define  DEFAULT_Kp 31
  #define  DEFAULT_Ki 2.5
  #define  DEFAULT_Kd 96
  #endif
  #else
